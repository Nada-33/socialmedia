...
import {
  Box, IconButton, InputBase, Select,
  Typography, useTheme, MenuItem, useMediaQuery,
  FormControl
} from '@mui/material';
import {
...
const Navbar = () => {
  ...
  // const fullName = "na da"


  //material ui component have padding style
  //else to use css => sx property
  return (
    <FlexBetween padding="1rem 6%" background={alt}>
      {/* //socialmedia and seacrh bar */}
